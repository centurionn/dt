...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ПоказатьПривязанные", Ложь);
...
&НаКлиенте
Процедура ПоказатьПривязанныеКОбъектамФайлыПриИзменении(Элемент)
	
	Список.Параметры.УстановитьЗначениеПараметра("ПоказатьПривязанные", ПоказатьПривязанныеКОбъектамФайлы);
