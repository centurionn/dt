	...
	Если Объект.Подготовлена Тогда
		...
		Если Объект.ИспользоватьЭлектроннуюПочту Тогда
			...
			Иначе
				...
				//ок)
				Если Не ПолучателиУказаны(Объект.Получатели, ПолучателиПоДаннымРегистра) Тогда
...
Процедура ВидимостьДоступностьКорректность(Форма, Изменения = "")
	...
	Если Изменения = ""
	 Или Изменения = "ВидРассылки"
	 Или Изменения = "ПолучателиРассылки"
	 Или Изменения = "ИспользоватьЭлектроннуюПочту" Тогда
		Если ЗначениеЗаполнено(Объект.ТипПолучателейРассылки)
		   И СтрНайти(Строка(Объект.ТипПолучателейРассылки), "(Регистр сведений)") > 0 Тогда
			Форма.ПолучателиПоДаннымРегистра = Истина;
		Иначе
			Форма.ПолучателиПоДаннымРегистра = Ложь;
		КонецЕсли;
		Элементы.ПолучателиРассылки.Видимость = Не Форма.ПолучателиПоДаннымРегистра;
	КонецЕсли;
	// ДИТ 56017 Давудов М.А. Конец: 13.07.2023
КонецПроцедуры
...
//ок)
Функция ПолучателиУказаны(Получатели, ПолучателиПоДаннымРегистра)
	
	Если ПолучателиПоДаннымРегистра Тогда
		Возврат Истина;
	КонецЕсли;
// ДИТ 56017 Давудов М.А. Конец: 13.07.2023
