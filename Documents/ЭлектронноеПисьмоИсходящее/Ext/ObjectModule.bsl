...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ЭтотОбъект.УдалятьПослеОтправки = Константы.УдалятьПисьмаПослеОтправки.Получить();
	
	//ДИТ, Беляев СЮ, ТА49361, 30-03-2022, начало         
	РегистрыСведений.ОтправленныеПоПочтеДокументы.ВыполнитьЗаписьПоДокументу_ЭлектронноеПисьмоИсходящее(ЭтотОбъект);
