...
//Евросиб Литвинов ( 12.11.2021 #42060 #0248963 
				...
				Если НЕ (ЗначениеЗаполнено(Форма.Элементы[ДополнительныеПараметры.ИмяЭлементаДляРазмещения].ПодчиненныеЭлементы) 
						И Форма.Элементы[ДополнительныеПараметры.ИмяЭлементаДляРазмещения].ПодчиненныеЭлементы.Количество()) Тогда
					Форма.Элементы[ДополнительныеПараметры.ИмяЭлементаДляРазмещения].Видимость = Ложь;
				КонецЕсли;
			КонецЕсли;
//Евросиб Литвинов ) 12.11.2021 #42060 #0248963 
