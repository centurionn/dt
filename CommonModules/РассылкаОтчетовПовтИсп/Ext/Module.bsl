...
Функция ТаблицаТиповПолучателей() Экспорт
	...
	НастройкиТипа = Новый Структура;
	НастройкиТипа.Вставить("ОсновнойТип",       Тип("РегистрСведенийМенеджерЗаписи.НастройкиРассылкиПДЗ"));
	НастройкиТипа.Вставить("ВидКИ", Справочники.ВидыКонтактнойИнформации.EmailФизическогоЛица);
	РассылкаОтчетов.ДобавитьЭлементВТаблицуТиповПолучателей(ТаблицаТипов, ДоступныеТипы, НастройкиТипа);
