...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	 ...
	 СписокОбъектов.Добавить(Документы.Калькуляция);
	 СписокОбъектов.Добавить(Документы.ПСЦ);
	 СписокОбъектов.Добавить(Документы.КредитнаяЗаявка);
	 СписокОбъектов.Добавить(Справочники.ДоговорыКонтрагентов);
	 СписокОбъектов.Добавить(Справочники.Контрагенты);
	 СписокОбъектов.Добавить(Документы.Заявка); // Евросиб Фролов, 28.04.2022 Task №50233
	 // Евросиб Фролов (06.12.2021 TASK№ №42618, РелизКлиента
	 //СписокОбъектов.Добавить(Документы.РелизКлиента);
	 // Евросиб Фролов)
	 
	 // ++ ДИТ_Агафонов_task 25372 10.10.2022
	 СписокОбъектов.Добавить(Справочники.ПакетыДокументов);
	 // -- ДИТ_Агафонов_task 25372 10.10.2022
	 СписокОбъектов.Добавить(Документы.ЗапросНаАвтоперевозку); //ДИТ Шевченко А.В. US 62492 ТА 68150 25.04.2023
	 
	 //Евросиб Каблов 27.05.2024 ( #67092
	 СписокОбъектов.Добавить(Документы.ПСЦПоставщика);
	 //Евросиб Каблов 27.05.2024 )
	 
	 // Евросиб US 90342 TA 90342 Рыбьяков К.А. 03.12.2025 ((
	 СписокОбъектов.Добавить(Документы.РеестрСпециальныхСтавок);
	 // Евросиб Рыбьяков К.А. 03.12.2025 ))
