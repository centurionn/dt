...
//  <ОставитьЦифры>  - <Булево> - <не удалять цифры>
//  <ОставитьЛатиницу>  - <Булево> - <не удалять буквы латиницы>
//  <ОставитьКириллицу>  - <Булево> - <не удалять буквы кириллицы>
// Возвращаемое значение:
//   <Тип.Вид>   - <описание возвращаемого значения>
//
Функция УдалитьПрочиеСимволыИзСтроки(Строка, ОставитьЦифры = Истина, ОставитьЛатиницу = Истина, ОставитьКириллицу = Истина) Экспорт

	//коды цифр 48-57
	//коды латиницы 65-90 и 97-122
	//коды кириллицы 1040-1103
	НоваяСтрока = "";
	Строка = СокрЛП(Строка);
	Для Сч = 1 По СтрДлина(Строка) Цикл
		Код = КодСимвола(Сред(Строка, Сч, 1));
		Если (ОставитьЦифры И Код >= 48 И Код <=57) 
			Или (ОставитьКириллицу И Код >= 1040 И Код <=1103)
			ИЛИ (ОставитьЛатиницу И ((Код >= 65 И Код <=90) ИЛИ (Код >= 97 И Код <=122)))Тогда
...
Функция СделатьСокрЛП(ИсходнаяСтрока) Экспорт
	
	Возврат СокрЛП(ИсходнаяСтрока);
	
КонецФункции

Функция СделатьСтрЗаменить(СтрокаТекст, ПодстрокаПоиска, ПодстрокаЗамены) Экспорт
	Возврат СтрЗаменить(СтрокаТекст, ПодстрокаПоиска, ПодстрокаЗамены);
КонецФункции 
...
//Евросиб(ДИТ), Беляев СЮ, US 103762 / TA 104186, 12-03-2025, начало (методы взяты из ОМ УправлениеКонтактнойИнформациейСлужебный)
#Область МетодыДляСтрокXML
