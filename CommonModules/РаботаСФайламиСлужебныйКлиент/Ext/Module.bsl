...
Функция ДобавитьИзФайловойСистемыСРасширениемСинхронно(ПараметрыВыполнения) Экспорт
	...
	//ДИТ Пак И.Т. Task34354 12.05.2021 Начало
	ДИТ_МультиВыбор = Ложь;
	Если ПараметрыВыполнения.Свойство("ДИТ_МножественныйВыбор") Тогда
		ДИТ_МультиВыбор = ПараметрыВыполнения.ДИТ_МножественныйВыбор;
	КонецЕсли;
	ДИТ_ВыбранныеФайлы = Новый Массив;
	Если ПараметрыВыполнения.Свойство("ПолноеИмяФайла") Тогда
		ДИТ_ВыбранныеФайлы.Добавить(ПараметрыВыполнения.ПолноеИмяФайла);
	КонецЕсли;
	//ДИТ Пак И.Т. Task34354 12.05.2021 Конец
	...
	Если Не ПараметрыВыполнения.Свойство("ПолноеИмяФайла") Тогда
		...
		//ДИТ Пак И.Т. Task34354 12.05.2021 Начало
		ДиалогВыбораФайла.МножественныйВыбор = ДИТ_МультиВыбор;
		//ДИТ Пак И.Т. Task34354 12.05.2021 Конец
		...
		//ДИТ Пак И.Т. Task34354 12.05.2021 Начало
		//++ Зубов 0239910 12.08.2021 не позволяет добавить один файл для контрагентов
		//Если ДИТ_МультиВыбор Тогда
		//	ДИТ_ВыбранныеФайлы = ДиалогВыбораФайла.ВыбранныеФайлы;
		//КонецЕсли;
		ДИТ_ВыбранныеФайлы = ДиалогВыбораФайла.ВыбранныеФайлы;
		//-- Зубов 0239910 12.08.2021
		//ДИТ Пак И.Т. Task34354 12.05.2021 Конец
...
//ДИТ Пак И.Т. Task34354 12.05.2021 Начало
Для каждого ДИТ_ПолноеИмяФайла Из ДИТ_ВыбранныеФайлы Цикл
	ПараметрыВыполнения.ПолноеИмяФайла = ДИТ_ПолноеИмяФайла;
//шшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшш - Ц И К Л - шшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшш
//ДИТ Пак И.Т. Task34354 12.05.2021 Конец
...
//ДИТ Пак И.Т. Task34354 12.05.2021 Начало
//шшшшшшшшшшшшшшшшшшшшшшшшшшшшшшшш - К О Н Е Ц   Ц И К Л А- шшшшшшшшшшшшшшшшшшшшшшшшшшшшш
КонецЦикла;	
//ДИТ Пак И.Т. Task34354 12.05.2021 Конец
...
Процедура ПолучитьРабочийКаталогПользователя(Оповещение)
	...
	//ДИТ, Давудов МА, Ticket#0273590, 13-04-2023, начало
	КаталогНаДиске = Новый Файл(ИмяКаталога);
	Если НЕ КаталогНаДиске.Существует() Тогда
		ИмяКаталога = КаталогВременныхФайлов();
	КонецЕсли;
	//ДИТ, Давудов МА, Ticket#0273590, 13-04-2023, конец
...
Процедура ДобавитьФайлИзФайловойСистемы(ВладелецФайла, ФормаВладелец) Экспорт
	...
	//ДИТ Пак И.Т. Task34354 12.05.2021 Начало
	ПараметрыВыполнения.Вставить("ДИТ_МножественныйВыбор",                  Истина);
	//ДИТ Пак И.Т. Task34354 12.05.2021 Конец
...
Процедура ДобавитьПослеВыбораРежимаСоздания(РежимСоздания, ПараметрыВыполнения) Экспорт
	...
	Если ТипЗнч(ПараметрыВыполнения.ВладелецФайла) = Тип("ДокументСсылка.Операция") Тогда
		ПараметрыВыполнения.Вставить("НеОткрыватьКарточкуПослеСозданияИзФайла", Ложь);
	Иначе
