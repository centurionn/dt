...
Процедура ОтчетСкомпоноватьРезультат(Команда)
	ОчиститьСообщения();
	//Евросиб Коханенко Н.А. #62069 05.12.2022 (  
	//Евросиб Коханенко Н.А. #64547 23.01.2023 ((  
	//перенесено в процедуру Сформировать()
	//ЗаписьВРССтатистикаОтчетовНаСервере(НастройкиОтчета.Наименование, ОтчетНаименованиеТекущегоВарианта);
	//Евросиб Коханенко Н.А. #64547 23.01.2023 ))  
	//Евросиб Коханенко Н.А. #62069 05.12.2022 )  
	Сформировать();
КонецПроцедуры  
...
//Евросиб Коханенко Н.А. #62069 05.12.2022 (  
&НаСервере
Процедура ЗаписьВРССтатистикаОтчетовНаСервере(НаименованиеОтчета, НаименованиеВарианта) 
	СтатистикаОтчетовСервер.ЗаписьВРССтатистикаОтчетовНаСервере(НаименованиеОтчета, НаименованиеВарианта); 
КонецПроцедуры
//Евросиб Коханенко Н.А. #62069 05.12.2022 )
...
Процедура УстановитьВидимостьДоступность(ПриСохраненииВарианта = Ложь)
	...
	//КонецЕсли;
	Заголовок = НастройкиОтчета.Наименование + " " + 
		?(ЗначениеЗаполнено(ОтчетНаименованиеТекущегоВарианта), "("+ОтчетНаименованиеТекущегоВарианта+")", "");
	//Евросиб Коханенко Н.А. #61705 01.12.2022 )
